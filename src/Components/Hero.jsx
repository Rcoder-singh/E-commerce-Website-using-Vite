      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
        ...
        <div className="relative">
          <img
            ...
            alt="hero image"
          />
          <div className="absolute max-w-[500px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-2">
            ...
            <div className="flex hover:bg-accentDark bg-accent text-white rounded-full w-fit items-center gap-4 px-4 py-2 text-[14px] sm:px-6 sm:py-3 cursor-pointer">
              Shop Now <BsArrowRight />
            </div>
          </div>
        </div>
